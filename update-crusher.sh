...
#  update-crusher.sh - update script to get the latest version of
#                      crusher.sh from GitHub by checking the repo
...
to_update=crusher.sh
location_latest=https://raw.github.com/Thoronador/shell-scripts/master/crusher.sh
